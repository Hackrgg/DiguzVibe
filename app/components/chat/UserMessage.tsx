...
export function UserMessage({ content, parts }: UserMessageProps) {
  ...
  if (Array.isArray(content)) {
    ...
    return (
      <div className="overflow-hidden flex flex-col gap-3 items-center ">
        ...
        <div className="flex flex-col gap-4 bg-accent-500/10 backdrop-blur-sm p-3 py-3 w-auto border border-bolt-elements-borderColor mr-auto">
  ...
  return (
    <div className="flex flex-col bg-accent-500/10 backdrop-blur-sm px-5 p-3.5 w-auto border border-bolt-elements-borderColor ml-auto">
